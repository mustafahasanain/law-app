...
import {
  Scale, BookOpen, Gavel, Briefcase, Shield, Copyright, Landmark,
  Heart, Car, Users, ShoppingBag, DollarSign, Baby,
  ArrowRight, Phone, CheckCircle, Clock, MapPin, Mail, ChevronRight,
  Award, TrendingUp, Eye
} from 'lucide-react';
...
const WHY_CHOOSE_US = [
  { icon: CheckCircle, title: 'Experienced Attorneys', desc: 'Over 25 years of combined legal experience fighting for our clients.' },
  { icon: Scale, title: 'Proven Track Record', desc: '98% success rate with thousands of cases won across all practice areas.' },
  { icon: Shield, title: 'Aggressive Defense', desc: 'We fight tirelessly to protect your rights and achieve the best outcome.' },
  { icon: Clock, title: '24/7 Availability', desc: 'Emergency legal services available around the clock when you need us most.' },
];

const TABS: { name: TabName; icon: React.ComponentType<{ size?: number; className?: string }> }[] = [
...
export function PracticeAreasPage() {
  ...
  return (
    <div className="overflow-x-hidden max-w-full">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 pb-4 border-b border-border-gray dark:border-gray-700">
                ...
                <div>
                  ...
                  <p className="text-gold text-sm uppercase tracking-wider font-semibold">{selectedArea.category}</p>
                </div>
              </div>
              ...
              {/* Key Services */}
              <div>
                <h3 className="text-lg font-bold text-charcoal dark:text-white mb-4" style={{ fontFamily: 'var(--font-playfair), serif' }}>
                  Key Services
                </h3>
                <div className="space-y-2.5">
                  {selectedArea.services.map((service) => (
                    <div key={service} className="flex items-center gap-3">
                      ...
                      <span className="text-charcoal dark:text-gray-300 text-sm">{service}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <PageHero title={t.practiceAreasPage.hero.title} breadcrumb={t.practiceAreasPage.hero.breadcrumb.current} />
        ...
        <div className="max-w-7xl mx-auto px-4">
          <AnimatedSection animation="fade-left">
            <div className="max-w-3xl mx-auto text-center">
              <SectionTitle title={t.practiceAreasPage.title} subtitle={t.practiceAreasPage.subtitle} />
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-charcoal relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <AnimatedSection animation="fade-left">
            <SectionTitle title={t.practiceAreasPage.whyChoose.title} subtitle={t.practiceAreasPage.whyChoose.subtitle} light />
          </AnimatedSection>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {t.practiceAreasPage.whyChoose.items.map((item: { title: string; desc: string }, index: number) => {
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-light-gray dark:bg-charcoal transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <AnimatedSection animation="fade-left">
              <div>
                <SectionTitle title={t.practiceAreasPage.moreAreas.title} subtitle="Full List" className="text-left [&>*]:text-left [&>*]:justify-start" />
            ...
            <AnimatedSection delay={200}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3">
                {t.practiceAreasPage.moreAreas.items.map((item: string) => (
                  <div key={item} className="flex items-center gap-2 py-2.5 border-b border-border-gray dark:border-gray-700 hover:border-gold transition-colors group cursor-pointer">
                    <ChevronRight size={14} className="text-gold shrink-0 group-hover:translate-x-1 transition-transform" />
                    <span className="text-charcoal dark:text-gray-300 text-sm group-hover:text-gold transition-colors">{item}</span>
                  </div>
                ))}
              </div>
            </AnimatedSection>
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-gold relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0" style={{
            backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 20px, rgba(51,51,51,0.1) 20px, rgba(51,51,51,0.1) 21px)',
          }} />
        </div>
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          <AnimatedSection>
            <h2 className="text-3xl md:text-4xl font-bold text-charcoal mb-4" style={{ fontFamily: 'var(--font-playfair), serif' }}>
